...
// Define your previous cycle data
let prevCycleData = [
...
questions.forEach((questionObj, index) => {
    ...
    ['Probability', 'Impact', 'Preparation'].forEach(choice => {
        ...
        // Display the previous cycle's data
        let prevDataP = document.createElement("p");
        prevDataP.innerText = `Previous value: ${prevCycleData[index].prevValue}, Average value: ${prevCycleData[index].avgValue}`;
        form.appendChild(prevDataP);
    });
